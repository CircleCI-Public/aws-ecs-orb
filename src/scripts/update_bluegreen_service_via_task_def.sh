...
ORB_EVAL_CD_APP_NAME=$(eval echo "$ORB_EVAL_CD_APP_NAME")
ORB_EVAL_CD_DEPLOY_GROUP_NAME=$(eval echo "$ORB_EVAL_CD_DEPLOY_GROUP_NAME")
ORB_EVAL_CD_LOAD_BALANCED_CONTAINER_NAME=$(eval echo "$ORB_EVAL_CD_LOAD_BALANCED_CONTAINER_NAME")
ORB_EVAL_CD_CAPACITY_PROVIDER_WEIGHT=$(eval echo "$ORB_EVAL_CD_CAPACITY_PROVIDER_WEIGHT")
ORB_EVAL_CD_CAPACITY_PROVIDER_BASE=$(eval echo "$ORB_EVAL_CD_CAPACITY_PROVIDER_BASE")
ORB_EVAL_CD_DEPLOYMENT_CONFIG_NAME=$(eval echo "$ORB_EVAL_CD_DEPLOYMENT_CONFIG_NAME")
