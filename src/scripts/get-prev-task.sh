...
{
  echo "PTD: ${PREVIOUS_TASK_DEFINITION}"
  echo "CINU: ${ECS_PARAM_CONTAINER_IMAGE_NAME_UPDATES}" 
  echo "CEVU: ${ECS_PARAM_CONTAINER_ENV_VAR_UPDATES}"
} >> test.txt
...
{
  echo "CCD: ${CLEANED_CONTAINER_DEFS}"
} >> test.txt
...
echo "RP: ${RUNTIME_PLATFORM}" >> test.txt
