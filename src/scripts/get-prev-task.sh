...

{
  ...
  echo "ECS_PARAM_CONTAINER_IMAGE_NAME_UPDATES: ${ECS_PARAM_CONTAINER_IMAGE_NAME_UPDATES}"
  echo "ECS_PARAM_CONTAINER_ENV_VAR_UPDATES: ${ECS_PARAM_CONTAINER_ENV_VAR_UPDATES}"
