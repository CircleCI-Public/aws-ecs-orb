...
ECS_PARAM_CONTAINER_SECRETS_UPDATES=$(eval echo "$ECS_PARAM_CONTAINER_SECRETS_UPDATES")
...
CONTAINER_DEFS=$(python "$UPDATE_CONTAINER_DEFS_SCRIPT_FILE" "$PREVIOUS_TASK_DEFINITION" "$ECS_PARAM_CONTAINER_IMAGE_NAME_UPDATES" "$ECS_PARAM_CONTAINER_ENV_VAR_UPDATES" "$ECS_PARAM_CONTAINER_SECRETS_UPDATES")
