...
class TestGetTaskDefinitionValue(unittest.TestCase):
    ...
    # task_dfn_runtime_platform = '{"taskDefinition":{"containerDefinitions":[{"name":"sample-app","image":"123456789012.dkr.ecr.us-west-2.amazonaws.com/aws-nodejs-sample:v1","memory":200,"cpu":10,"essential":true}],"family":"example_task_3","runtimePlatform":{"cpuArchitecture":"AMD64","operatingSystemFamily":"LINUX"}}}'
