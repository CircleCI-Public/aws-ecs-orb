...
ORB_EVAL_CONTAINER_IMAGE_NAME_UPDATES=$(eval echo "$ORB_EVAL_CONTAINER_IMAGE_NAME_UPDATES")
ORB_EVAL_CONTAINER_ENV_VAR_UPDATE=$(eval echo "$ORB_EVAL_CONTAINER_ENV_VAR_UPDATE")
ORB_EVAL_PROFILE_NAME=$(eval echo "$ORB_EVAL_PROFILE_NAME")
ORB_EVAL_CONTAINER_SECRET_UPDATES=$(eval echo "$ORB_EVAL_CONTAINER_SECRET_UPDATES")
ORB_EVAL_CONTAINER_DOCKER_LABEL_UPDATES=$(eval echo "$ORB_EVAL_CONTAINER_DOCKER_LABEL_UPDATES")
ORB_EVAL_PREVIOUS_REVISION_NUMBER=$(eval echo "$ORB_EVAL_PREVIOUS_REVISION_NUMBER")

if [ -z "${ECS_PARAM_PREVIOUS_REVISION}" ]; then
  ECS_TASK_DEFINITION_NAME="$ORB_EVAL_FAMILY"
else
  ECS_TASK_DEFINITION_NAME="$ORB_EVAL_FAMILY:$ORB_EVAL_PREVIOUS_REVISION_NUMBER"
fi
...
CONTAINER_DEFS=$(python "$UPDATE_CONTAINER_DEFS_SCRIPT_FILE" "$PREVIOUS_TASK_DEFINITION" "$ORB_EVAL_CONTAINER_IMAGE_NAME_UPDATES" "$ORB_EVAL_CONTAINER_ENV_VAR_UPDATE" "$ORB_EVAL_CONTAINER_SECRET_UPDATES" "$ORB_EVAL_CONTAINER_DOCKER_LABEL_UPDATES")
