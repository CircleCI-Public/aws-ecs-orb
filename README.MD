...
| container-env-var-updates        | string  | ""   | "Use this to update or set the values of environment variables that will be defined for the containers. (Existing environment variables not included in this parameter will not be removed) <br>**Expected format**: container=\<container-name\>,name=\<env-var-name\>,value=\<env-var-value\>,container=...,name=...,value=...,container=...,name=...,valueFrom=...,<br>Values should not contain commas. |
